                  ...
                  <div>
                    <div class="scrollactive-nav show-lg-up scrollnav">
                      <ul>
                        ...
                        <li><a class="btn btn-flat anchor-link waves-effect" href="#promotions">Jobs</a></li>
                        <li><a class="btn btn-flat anchor-link waves-effect" href="#top">top categories</a></li>
