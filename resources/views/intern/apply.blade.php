        ...
        <header class="app-bar header invert" id="header">
          ...
          <div class="container-general">
            <div class="container">
              <div class="col-md-12">
                  <div class="box-form">
                    <div class="row justify-content-between mt-5 ml-5">
                        <div>
                          <h4 class="secondary-title headingMagang"><span class="lowongan">Melamar</span> Magang</h4>
                        </div>
                    </div>
                      ...
                      <form action="" method="post">
                        ...
                        <div class="col-sm-12">
                            <div class="input-field filled dark">
                                <label for="namaUser">Masukkan Nama</label>
                                <input class="validate" id="namaUser" type="text" name="namaUser" required autocomplete="off">
                            </div>
                        </div>
                        <div class="col-sm-12">
                            <div class="input-field filled dark">
